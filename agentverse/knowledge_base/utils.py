...
from agentverse.configs.model_config import (
    EMBEDDING_MODEL,
    KB_ROOT_PATH,
    CHUNK_SIZE,
    OVERLAP_SIZE,
...
import importlib
from agentverse.text_splitter import zh_title_enhance as func_zh_title_enhance
...
from agentverse.utils import run_in_thread_pool, embedding_device
import io
...
def load_embeddings(model: str = EMBEDDING_MODEL, device: str = embedding_device()):
    ...
    '''
    from agentverse.knowledge_base.kb_cache.base import embeddings_pool
